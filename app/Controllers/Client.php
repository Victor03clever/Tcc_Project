...
class  Client  extends Controller
{
  ...
  public function __construct()
  {
    ...
    $this->Products = $this->model("client\Home");
  ...
  public function makeRequest()
  {
    ...
    //  var_dump($formulario);
    //  exit;
      $id = trim($formulario['idGo']);
      if ($this->Products->getProductsByOne($id)) {

        $dados = $this->Products->getProductsByOne($id);
        $qtd = trim($formulario['qtdP']);
