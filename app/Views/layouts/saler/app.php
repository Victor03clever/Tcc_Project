      ...
      <div class="user">
        ...
        <div class="notify" title="pedidos">
          <a href="#" class="text-decoration-none position-relative">
            ...
            <span id="total" url="<?=URL?>" class="position-absolute  rounded-5" style="background: #065E7C; left:.9rem; top: -1.5rem; color:var(--new); width:1.6rem; height:1.6rem; text-align:center">0</span>
          </a>
        </div>
        <span class="img">
          <img src="<?= asset("img/user.png") ?>" alt="imagem do usuario">
        </span>
        <!-- dropdown -->
        <div class="dropdown">
    ...
    <div class="modal-dialog        ">
      <div class="modal-content">
        ...
        <a class="btn btn-secondary btn-lg" data-bs-dismiss="modal">Cancelar</a>
          <a href="<?= URL ?>/saler/sair" class="btn btn-primary btn-lg" >Sair</a>
        </div>
      </div>
    </div>
  </div>
