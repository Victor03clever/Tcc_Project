          ...
          <section class="section profile">
            <div class="row">
              ...
              <div class="col-xl-8">
                <div class="card p-3">
                  <!-- Profile Edit Form -->
                  <form method="post" action="<?= URL ?>/admin/config" enctype="multipart/form-data">

                    <div class="row mb-3">
                      <label for="upload" class="col-md-4 col-lg-3 col-form-label">Foto de perfil</label>
                      <div class="col-md-8 col-lg-9">
                        <figure for="upload" title="Clique para procurar">
                          <img src="<?= $_SESSION['usuarios_img'] ?>" alt="Profile" width="120" height="120" data-bs-toggle="modal" data-bs-target="#uploadmodalA">
                        </figure>
                        <div class="pt-2">

                          <a class="btn btn-lg " title="Carregar nova foto" style="background:#065e7c;color:#dce0ea; width:initial; height:initial;" data-bs-toggle="modal" data-bs-target="#uploadmodalA"><i class="bi bi-upload fs-5"></i></a>

                          <a href="<?= URL ?>/admin/config/deletetofo" class="btn btn-danger btn-lg " title="Remove my profile image"><i class="bi bi-trash3"></i></a>


                          <!-- Modal -->
                          <div class="modal fade" id="uploadmodalA" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
