                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <label for="upload" title="Clique para procurar">
                                                    <img src="<?= $_SESSION['usuarios_img'] ?>" alt="Profile" width="120" height="120"></label>
                                                <input type="file" name="upload" id="upload" hidden>
                                                <div class="pt-2">

                                                    <button type="submit" class="btn " style="background:#065e7c;color:#dce0ea" title="Carregue nova foto" name="load" value="2">alterar</button>

                                                    <a href="<?= URL ?>/admin/Config/deletetofo" class="btn btn-danger " title="Remove my profile image">eliminar</a>
                                                </div>
                                            </div>
                                        </div>
