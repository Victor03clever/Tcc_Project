...
<section class="section">
    <h1>Produtos / Estoque / Entrada</h1>
    ...
    <form action="<?= URL ?>/admin/estoque/create" method="post" enctype="multipart/form-data">
        <p>
        ...
        <button type="submit" class="btn btn-primary" name="store" value="submit">Entrar</button>
